...
>
> ### Формирование версий
> - первая цифра - 0, скорее всего навсегда такой и будет. 
> - вторая цифра - означает слом протокола, т.е. клиент версии `0.5.х` не сможет работать с сервером версии `0.6.х`. При смене версии придется обновить приложения у всех клиентов (возможно конфиги) 
> - третья цифра - фичи
> 
> [source](https://github.com/ZeroTworu/anet/issues/36#issuecomment-4366304721)
